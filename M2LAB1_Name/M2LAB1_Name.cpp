...
const double WHOLESALE_PRICE_PER_CUBICFT = 0.23;												// Wholesale price of crate material in $ per cubic ft
const double RETAIL_PRICE_PER_CUBICFT = 0.50;													// Retail price of crate material in $ per cubic ft
